...
Status: Plan 1 done. The pure translation library gapura-core is implemented with unit, golden, and property tests (see Development). The proxy, the Kubernetes controller, and the Helm chart are not built yet.
