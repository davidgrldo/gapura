...
36 of 37 core tests pass, 1 fails, 0 are skipped; the extended section is 4 of 4 — RequestMirror
and the 303/307/308 redirect codes. The report result is therefore still `failure` — the core
failure decides it — so it is not submittable upstream yet. The remaining failure is architectural, not a bug:
